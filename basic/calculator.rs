...
fn main() {
    assert_eq!(Calculator::exec_str("-(3+(4+5))"), -12);
    assert_eq!(Calculator::exec_str("1+2"), 3);
    assert_eq!(Calculator::exec_str("-1+ +2--3+-4"), -1 + 2 - (-3) - 4);
    assert_eq!(Calculator::exec_str("3*(4+5)"), 27);
    assert_eq!(Calculator::exec_str(" 3+(2*2)"), 7);
    assert_eq!(Calculator::exec_str("3/2"), 1);
    assert_eq!(Calculator::exec_str("3+5/2"), 5);
    assert_eq!(Calculator::exec_str("2-1+2"), 3);
    assert_eq!(Calculator::exec_str("(1+(4+5+2)-3)+(6+8)"), 23);
}
